...
class WiredScienceGrabber extends BaseGrabber {
    public function getId(): string { return 'wired_science'; }
    public function getName(): string { return 'Wired Science'; }
    public function getUrl(): string { return 'https://www.wired.com/category/science/'; }
    public function getDefaultCategory(): string { return 'elm'; }
