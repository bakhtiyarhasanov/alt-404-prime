...
class BreakingDefenseGrabber extends BaseGrabber {
    public function getId(): string { return 'breaking_defense'; }
    public function getName(): string { return 'Breaking Defense Networks'; }
    public function getUrl(): string { return 'https://breakingdefense.com/category/networks-and-digital-warfare/'; }
    ...
    public function grabArticle(string $url, string $fallbackTitle = ''): ?array {
        ...
        $bodyNodes = $xpath->query(
            ...
            "//div[contains(@class, 'single-article-content')]//p"
        );
        ...
        return [
            ...
            'tags' => ['Breaking Defense', 'Networks', 'Digital Warfare', 'Tech'],
