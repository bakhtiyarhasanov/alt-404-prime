...
class BgrNewsGrabber extends BaseGrabber {
    public function getId(): string { return 'bgr_news'; }
    public function getName(): string { return 'BGR News'; }
    public function getUrl(): string { return 'https://www.bgr.com/category/news/'; }
