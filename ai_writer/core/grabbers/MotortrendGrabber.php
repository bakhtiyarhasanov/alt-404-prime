...
class MotortrendGrabber extends BaseGrabber {
    public function getId(): string { return 'motortrend'; }
    public function getName(): string { return 'MotorTrend'; }
    public function getUrl(): string { return 'https://www.motortrend.com/news'; }
    public function getDefaultCategory(): string { return 'avto'; }
