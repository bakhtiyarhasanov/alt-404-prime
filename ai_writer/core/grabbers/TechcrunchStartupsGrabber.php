...
class TechcrunchStartupsGrabber extends BaseGrabber {
    public function getId(): string { return 'techcrunch_startups'; }
    public function getName(): string { return 'TechCrunch Startups'; }
    public function getUrl(): string { return 'https://techcrunch.com/category/startups/'; }
