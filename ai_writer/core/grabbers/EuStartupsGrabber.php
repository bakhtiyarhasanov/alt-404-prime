...
class EuStartupsGrabber extends BaseGrabber {
    public function getId(): string { return 'eu_startups'; }
    public function getName(): string { return 'EU-Startups'; }
    public function getUrl(): string { return 'https://www.eu-startups.com/'; }
    ...
    public function grabArticle(string $url, string $fallbackTitle = ''): ?array {
        ...
        return [
            ...
            'tags' => ['EU-Startups', 'Startups', 'News'],
