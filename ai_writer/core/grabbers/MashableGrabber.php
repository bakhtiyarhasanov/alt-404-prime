...
class MashableGrabber extends BaseGrabber {
    public function getId(): string { return 'mashable'; }
    public function getName(): string { return 'Mashable'; }
    public function getUrl(): string { return 'https://mashable.com/articles'; }
