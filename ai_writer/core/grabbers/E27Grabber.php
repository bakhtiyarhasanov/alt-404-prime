...
class E27Grabber extends BaseGrabber {
    public function getId(): string { return 'e27'; }
    public function getName(): string { return 'e27'; }
    public function getUrl(): string { return 'https://e27.co/news/'; }
