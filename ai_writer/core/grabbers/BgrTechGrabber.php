...
class BgrTechGrabber extends BaseGrabber {
    public function getId(): string { return 'bgr_tech'; }
    public function getName(): string { return 'BGR Tech'; }
    public function getUrl(): string { return 'https://www.bgr.com/category/tech/'; }
