...
class PcmagGrabber extends BaseGrabber {
    public function getId(): string { return 'pcmag'; }
    public function getName(): string { return 'PCMag'; }
    public function getUrl(): string { return 'https://www.pcmag.com/news'; }
